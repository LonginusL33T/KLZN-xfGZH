...
import { dictionaryList, areaList, getSignature, uploadImg, addDevice } from '@/axios/request'
...
export default {
    ...
    mounted() {
        ...
        this.currentDevice.projectId = params.projectId
        this.$nextTick(() => {
            // 注入权限验证配置
            this.wxScan();
            this.getList();
    ...
    methods: {
        ...
        addDevice() {
            ...
            this.currentDevice.sim = this.sim
            ...
            Global.publicAxiosRequest(this.currentDevice, addDevice, (data, msg) => {
