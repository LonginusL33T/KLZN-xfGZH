...
import { dictionaryList, deviceList, setProjectDevice } from '@/axios/request'
...
export default {
    ...
    methods: {
        ...
        getList(){
            ...
            Global.publicAxiosRequest(params1, deviceList, (data, msg) => {
        ...
        saveDevice() {
            ...
            this.$dialog.confirm({
                ...
                Global.publicAxiosRequest(params, setProjectDevice, (data, msg) => {
